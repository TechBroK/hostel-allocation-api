...
import { createComplaintService, getComplaintsByStudentService, updateComplaintService } from '../services/controllers/complaintService.js';
...
export const updateComplaint = async (req, res, next) => {
	try {
		...
		const result = await updateComplaintService({ requester: req.user, complaintId, payload: req.validated || req.body });
